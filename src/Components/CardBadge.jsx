...
import {
  ...
  incrementQty,
  remove,
} from "../Fuetures/AddToCard/CardSlice";
...
const CardBadge = () => {
  ...
  return (
    <>
     ...
     <div>
     <Typography variant="h4" color={"whitesmoke"} id="" margin={2}>
          CART
        </Typography>
        <Typography variant="body1" color={"whitesmoke"} id="method" margin={2}>
